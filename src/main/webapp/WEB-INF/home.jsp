    ...
    <% if (user != null) { %>
        ...
        <div style="margin-top: 3rem; margin-bottom: 3rem;">
            ...
            <div class="grid" style="grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));">
                <a href="<%= request.getContextPath() %>/cars" class="card" style="text-decoration: none; color: inherit; transition: all 0.3s;">
                    <div style="font-size: 2.5rem; margin-bottom: 1rem;">🚗</div>
                    <h4 style="margin: 0 0 0.5rem 0;">View Cars</h4>
                    <p style="margin: 0; color: #6b7280;">Manage vehicle fleet</p>
                </a>

                <a href="<%= request.getContextPath() %>/customers" class="card" style="text-decoration: none; color: inherit; transition: all 0.3s;">
                    <div style="font-size: 2.5rem; margin-bottom: 1rem;">👥</div>
                    <h4 style="margin: 0 0 0.5rem 0;">Customers</h4>
                    <p style="margin: 0; color: #6b7280;">Manage client database</p>
                </a>

                <a href="<%= request.getContextPath() %>/rentals" class="card" style="text-decoration: none; color: inherit; transition: all 0.3s;">
                    <div style="font-size: 2.5rem; margin-bottom: 1rem;">📋</div>
                    <h4 style="margin: 0 0 0.5rem 0;">Rentals</h4>
                    <p style="margin: 0; color: #6b7280;">View all rental bookings</p>
                </a>

                <a href="<%= request.getContextPath() %>/addRental" class="card" style="text-decoration: none; color: inherit; transition: all 0.3s;">
                    <div style="font-size: 2.5rem; margin-bottom: 1rem;">➕</div>
        ...
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 2rem; border-radius: 12px; text-align: center;">
            ...
            <div style="margin-top: 1.5rem;">
                <a href="<%= request.getContextPath() %>/addcar" class="btn btn-secondary" style="margin-right: 1rem;">Add New Car</a>
                <a href="<%= request.getContextPath() %>/addCustomer" class="btn btn-secondary">Register Customer</a>
            </div>
        </div>

        <div style="text-align: center; margin-top: 2rem;">
            <a href="<%= request.getContextPath() %>/logout" style="color: #ef4444; text-decoration: none; font-weight: 600;">
                🚪 Logout
            </a>
        </div>
